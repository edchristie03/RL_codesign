...
# CMA-ES Parameters
LAMBDA = 2 # Population size (offspring per generation)
SIGMA0 = np.array([40, 40, 40, 40, 40])  # Initial standard deviation
MAX_GENERATIONS = 1  # Maximum number of complete generations
...
def train_from_scratch(id, design_vector, generation, experiment_id):
    ...
    model.learn(total_timesteps=100000, callback=[eval_callback, best_ckpt])
