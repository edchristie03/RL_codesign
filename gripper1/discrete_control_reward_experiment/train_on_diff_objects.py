...
if __name__ == "__main__":
    ...
    for shape_name, vertex in shape_vertices.items():
        ...
        try:
            model.learn(total_timesteps=10_000_000, callback=[eval_callback, best_ckpt])
        except KeyboardInterrupt:  # only abort the current learn()
            print(f"Interrupted: skipping the rest of {shape_name}")
