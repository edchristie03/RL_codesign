...
from pymunk_experiments_2.grippers import Gripper
from pymunk_experiments_2.objects import Ball, Floor, Poly, Walls
from pymunk_experiments_2 import objects, grippers

class Environment(gym.Env):

    def __init__(self, vertex, training=True, render_mode=None, design_vector=(150, 1e12)):
...
if __name__ == "__main__":
    ...
    eval_callback = EvalCallback(eval_env, n_eval_episodes=1, eval_freq=1000, render=True, verbose=0, deterministic=True)
